                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#banned" data-toggle="tab">Banned</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="#withdraw" data-toggle="tab">Withdraw</a>
                            </li>
                        </ul>
                    </div><!-- /.card-header -->
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="active tab-pane" id="status">
                                <!-- Post -->
                                <form class="form-horizontal" action="{{ route('user.profile.status.update') }}" method="POST"
                            ...
                            <div class="tab-pane" id="banned">
                                <form class="form-horizontal" action="{{ route('user.profile.banned.status') }}"
                                    method="POST">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $user->id }}">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">Banned Status</label>
                                        <div class="col-sm-10">
                                            <select name="status" class="form-control status" id="">
                                                <option value="1">Confirm</option>
                            ...
                            <div class="tab-pane" id="withdraw">
                                <form class="form-horizontal" action="{{ route('user.profile.withdraw.status') }}"
                                    method="POST">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $user->id }}">
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">Withdraw Status</label>
                                        <div class="col-sm-10">
                                            <select name="status" class="form-control status" id="">
                                                <option value="1">Confirm</option>

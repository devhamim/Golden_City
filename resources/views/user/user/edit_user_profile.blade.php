                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id=""
                                            placeholder="If you change email ID must be entire secure code " value="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id=""
                                            placeholder="Full Name " value="anju Sona">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id=""
                                            placeholder="User Name " value="testid">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id=""
                                            placeholder="Email  " value="clsanjoy@gmail.com">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id=""
                                            placeholder="Mobile " value="01245562355">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Reference<strong class="text-danger">*</strong></label>
                                        <input type="text" class="form-control" id=""
                                            placeholder="Reference " value="R70702">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id=""
                                            placeholder="Position " value="P10102">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Guardian Name<strong class="text-danger">*</strong></label>
                                        <input type="text" class="form-control" id=""
                                            placeholder="Guardian Name " value="Guardian">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id=""
                                            placeholder="Account Number " value="aet346754">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Fax No<strong class="text-danger">*</strong></label>
                                        <input type="text" class="form-control" id=""
                                            placeholder="Fax No" value="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>NID / Passport<strong class="text-danger">*</strong></label>
                                        <input type="text" class="form-control" id=""
                                            placeholder="NID / Passport" value="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Blood<strong class="text-danger">*</strong></label>
                                        <input type="text" class="form-control" id=""
                                            placeholder="Blood" value="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Registration Date<strong class="text-danger">*</strong></label>
                                        <input type="date" class="form-control" id=""
                                            placeholder="Date of birth" value="">
                                    </div>
                                </div>
